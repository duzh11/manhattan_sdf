...
```shell
python train_net.py --cfg_file configs/scannet/0050_server.yaml gpus 0, exp_name test3_0050
```

### Mesh extraction

```shell
python run.py --type mesh_extract --cfg_file configs/scannet/0050.yaml gpus 0, exp_name scannet_0050
```
